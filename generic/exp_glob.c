 ...
 * exp_glob.c --
 *
 *	expect functions for doing glob.  Based on Tcl's glob functions but
 *	modified to support anchors and to return information about the
 *	possibility of future matches.
 * 
 * ----------------------------------------------------------------------------
 *
 ...
 * ----------------------------------------------------------------------------
 * RCS: @(#) $Id: exp_glob.c,v 1.1.2.1.2.2 2002-02-10 12:04:21 davygrvy Exp $
 * ----------------------------------------------------------------------------
 */
